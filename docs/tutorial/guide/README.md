...
- **Neither set duplicates the other.** This guide teaches concepts;
  ...
  built it) wins — file a problem in `problems_master.md` and fix this
  guide.
...
`problems_phase_15.md`). Reusing or renumbering any of those filenames
...
| 17 | [CI/CD](17-ci-cd.md) | `.github/workflows/`, `services/*/Dockerfile` | `problems_phase_12.md` |
...
- Every captured "expected output" block was produced by actually
  ...
  `problems_phase_15.md` for exactly which commands were run.
